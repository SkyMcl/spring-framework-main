...
<<<<<<< HEAD
				// 判断根webApplicationContext对象是否刷新过
=======
>>>>>>> b441c4e07c829610ea8c8b19abf7dd86ef197ad2
				if (!cwac.isActive()) {
...
<<<<<<< HEAD
		...
		// 添加监听器ContextRefreshListener  被调用后执行 子类DispatcherServlet的onRefresh 方法 完成初始化9大组件
=======
